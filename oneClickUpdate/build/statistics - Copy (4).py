...
def statistics(request, type):
    ...
    for item in StatData:
        ...
        if i == 0 :
            i = 1
            CompareDataMin[0],CompareDataMin[1],CompareDataMin[2],CompareDataMin[3],CompareDataMin[4] = item[4],item[10],item[12],item[7],item[11]
            CompareDataMax[0],CompareDataMax[1],CompareDataMax[2],CompareDataMax[3],CompareDataMax[4] = item[4],item[10],item[12],item[7],item[11]
        else:
            if item[4] < CompareDataMin[0]:CompareDataMin[0] = item[4]
            ...
            if item[4] > CompareDataMax[0]:CompareDataMax[0] = item[4]
